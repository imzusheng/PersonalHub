...
const api = {
  ...
  disablePlugin: (pluginId) => ipcRenderer.invoke('ph:disablePlugin', pluginId),
  enablePlugin: (pluginId) => ipcRenderer.invoke('ph:enablePlugin', pluginId),
  unregisterPlugin: (pluginId) => ipcRenderer.invoke('ph:unregisterPlugin', pluginId),
